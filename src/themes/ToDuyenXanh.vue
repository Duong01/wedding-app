<template>
  <div class="tdx-theme" :data-theme="theme.Name" :style="themeStyle">
    <!-- =====================================================
         MÀN HÌNH MỞ THIỆP
    ====================================================== -->
    ...
    <main v-else class="tdx-invitation">
      <!-- ============ HERO ============ -->
...
import OpeningScreen from "@/page/ToDuyenXanh/OpeningScreen.vue";
import WeddingHero from "@/page/ToDuyenXanh/WeddingHero.vue";
import WeddingCouple from "@/page/ToDuyenXanh/WeddingCouple.vue";
import WeddingStory from "@/page/ToDuyenXanh/WeddingStory.vue";
import WeddingEvents from "@/page/ToDuyenXanh/WeddingEvents.vue";
import WeddingGallery from "@/page/ToDuyenXanh/WeddingGallery.vue";
import WeddingMap from "@/page/ToDuyenXanh/WeddingMap.vue";
import DressCode from "@/page/ToDuyenXanh/DressCode.vue";
import Timeline from "@/page/ToDuyenXanh/Timeline.vue";
import WeddingGifts from "@/page/ToDuyenXanh/WeddingGifts.vue";
import WeddingWishes from "@/page/ToDuyenXanh/WeddingWishes.vue";
import WeddingFooter from "@/page/ToDuyenXanh/WeddingFooter.vue";
...
.tdx-theme {
  ...
  background-color: var(--background, #fefbf4);

  color: var(--text, #1a3500);
