...
.sg-particle--2 { left: 16%; font-size: 11px; animation-duration: 14s; animation-delay: 2.2s; }
.sg-particle--3 { left: 27%; font-size: 15px; animation-duration: 12.5s; animation-delay: 1s; }
.sg-particle--4 { left: 38%; font-size: 10px; animation-duration: 15s; animation-delay: 3.4s; }
.sg-particle--5 { left: 49%; font-size: 11px; animation-duration: 10.5s; animation-delay: 0.8s; }
.sg-particle--6 { left: 60%; font-size: 11px; animation-duration: 13.5s; animation-delay: 2.8s; }
.sg-particle--7 { left: 70%; font-size: 14px; animation-duration: 12s; animation-delay: 1.6s; }
.sg-particle--8 { left: 80%; font-size: 10px; animation-duration: 14.5s; animation-delay: 4s; }
.sg-particle--9 { left: 89%; font-size: 12px; animation-duration: 11.5s; animation-delay: 0.4s; }
.sg-particle--10 { left: 95%; font-size: 11px; animation-duration: 15.5s; animation-delay: 3s; }
.sg-particle--11 { left: 44%; font-size: 11px; animation-duration: 16s; animation-delay: 5s; }
