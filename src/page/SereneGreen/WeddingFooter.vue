<template>
  <footer class="sg-footer">
    <div class="sg-footer__glow sg-footer__glow--left"></div>
    <div class="sg-footer__glow sg-footer__glow--right"></div>

    <div class="sg-footer__petal sg-footer__petal--1">❀</div>
    <div class="sg-footer__petal sg-footer__petal--2">✿</div>
    <div class="sg-footer__petal sg-footer__petal--3">❀</div>

    <div class="sg-footer__inner">
      <div class="sg-footer__ring">
      ...
      <p class="sg-footer__thanks">
        CẢM ƠN BẠN ĐÃ ĐẾN CHUNG VUI<br />
        CÙNG CHÚNG MÌNH
      </p>

      <div class="sg-footer__date">{{ weddingDate }}</div>

      <small class="sg-footer__copyright">© {{ currentYear }} · Made with love</small>
    </div>
  </footer>
</template>
...
.sg-footer__petal {
  ...
  animation: sg-footer-sway 6s ease-in-out infinite;
}
